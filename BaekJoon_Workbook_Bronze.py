...
def q18108():
    # 백준 파이썬 1998년생인 내가 태국에서는 2541년생?!
    y = int(input())
    print(str(y - 543))
...
def q15881():
    # 백준 파이썬 Pen Pineapple Apple Pen
    n = int(input())
    s = input()
    chk = 'pPAp'
    index = 0
